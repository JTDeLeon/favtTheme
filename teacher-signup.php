<?php
/** 
 * Template Name: Teacher Sign Up Page
 */
...
?>
	...
	<div>
		<div class="header">
			...
			<p class="logo-text">Find a Virtual Teacher</p>
			</div>
			<h1 class="header__title">WE EMPOWER YOU TO EDUCATE AT YOUR CONVENIENCE</h1>
			<div class="header__log">
				<!-- <svg class="header__log--icon" width="24" height="24" viewBox="0 0 24 24"> -->
			<!-- <path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"></path> -->
			<!-- </svg> -->
				<a href="#cta-area" class="header__log--text">Sign Up</a>
			</div>
			</div>
			...
			<div class="why-virtual">
				...
				<div class="why-virtual__text">
					...
					<br>
					<p class="why-virtual__text--content">As a certified educator and teacher, you have the power to promote and provide education. You have the freedom and flexibility to choose the path of which you educate others, and the knowledge and experience to do so. Families need you. Register today and start on your virtual education path.</p>
				</div>
			</div>

			<div class="about">
				<div class="about__title">
					<h1 class="about__title--text">We Are Here To Accelerate Learning</h1>
				</div>
			...
			<div id="cta-area" class="cta-area">
				<a href="/teacher-form">Sign Up Now</a>
			</div>
